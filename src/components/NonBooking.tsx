...
<div className='bg-white border'>
    <div className='bg-blue-900 h-auto p-3 border border-gray-400 flex justify-between '>
        <p className='text-white font-semibold text-left'>TIKET NON-BOKING</p>
    ...
    <div className='bg-blue-900 h-auto py-4 px-10 '>
        ...
        {/* <p className='text-2xl font-semibold text-white'>ANTRIAN</p> ini antrian */}
    </div>
